...
- 顶部的「目标 / 日期」选择栏在多个页面通用；「统计」页另有**日期范围选择器**：
  - 左侧预设：当天 / 今天 / 昨天 / 近 7 天 / 近 30 天 / 本月 / 上月 / 自定义；
  - 选「自定义」时，在双月日历上依次点选开始与结束日期（未来日期不可选，区间内日期高亮）；
  - 选定的范围会同时用于统计卡片、每日消息量、活跃发言人 Top 10、时段分布与总结的趋势参考。
